...
# Gleichung (28)
# TODO: Hinzufügen einer Bedingung das: F_st/(n*A_s) < σ_fin = 50 * 10**6
...
# Gleichung (29)
def δ_end(δ_1: float, T_k1: float, T_res: float) -> float:
    """
...
# Gleichung (32)
def φ_ohne_schlaufe(T_k1: float, T_res: float, r: float, δ_end: float) -> float:
    """
